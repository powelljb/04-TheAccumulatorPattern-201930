...
#            for _ in range(n):
#        What does the   _   (underscore) mean? The underscore means that there is no
#        variable given the value of n.  The loop will go through n times.
#
...
#
#              x = starting_point.x   THIS IS THE WRONG ONE, NO ACCUMULATOR PRESENT
#              for k in range(n):
